...
def add_meals():
    ...
    meals_to_add = [
        ...
        Meal(
            ...
            date="2026-02-18",
            heure="Soir",
            tags=["poireau", "lardon", "pâte brisée"],
            recipe=None
        ),
        Meal(
            ...
            date="2026-02-19",
            heure="Soir",
            tags=["chou-fleur", "pois chiche", "curry"],
            recipe=None
        ),
        Meal(
            name="Fajitas / Tacos",
            date="2026-02-20",
            heure="Soir",
            tags=["poulet", "tortilla", "poivron", "oignon"],
            recipe=None
        ),
        Meal(
        ...
        Meal(
            ...
            date="2026-02-21",
            heure="Soir",
            tags=["pâtes", "viande hachée", "tomate", "béchamel"],
            recipe=None
        ),
    ]
